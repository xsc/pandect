...
(do
 (do
  (clojure.core/defprotocol G__1061 (compute-sha3-2561059 [data1060]))
  (clojure.core/doseq
   [v__166__auto__ [#'G__1061 #'compute-sha3-2561059]]
  ...
  (clojure.core/extend-protocol
   ...
   (compute-sha3-2561059
    [data1060]
    (clojure.core/let
     [data1060 (.getBytes data1060 "UTF-8")]
     (clojure.core/let
      [buf__882__auto__
       data1060
       digest__883__auto__
  ...
  (clojure.core/extend-protocol
   ...
   (compute-sha3-2561059
    ...
    (clojure.core/with-open
     [data1060 (clojure.java.io/input-stream data1060)]
     (clojure.core/let
      [s__886__auto__
       data1060
       c__887__auto__
 ...
 (do
  ...
  (clojure.core/defn
   ...
   [x]
   (pandect.utils.convert/bytes->hex (compute-sha3-2561059 x)))
  (clojure.core/defn
   sha3-256-file
...
(do
 (do
  (clojure.core/defprotocol
   G__1065
   (compute-sha3-2561062 [data1063 key1064]))
  (clojure.core/doseq
   [v__166__auto__ [#'G__1065 #'compute-sha3-2561062]]
   (clojure.core/alter-meta!
    v__166__auto__
    clojure.core/assoc
    :private
  ...
  (clojure.core/extend-protocol
   G__1065
   (clojure.core/class (clojure.core/byte-array 0))
   (compute-sha3-2561062
    [data1063 key1064]
    (clojure.core/let
     [buf__869__auto__
      data1063
      k__870__auto__
      (org.bouncycastle.crypto.params.KeyParameter. key1064)
      mac__871__auto__
   ...
   (compute-sha3-2561062
    [data1063 key1064]
    (clojure.core/let
     [data1063 (.getBytes data1063 "UTF-8")]
     (clojure.core/let
      [buf__869__auto__
       data1063
       k__870__auto__
  ...
  (clojure.core/extend-protocol
   ...
   (compute-sha3-2561062
    [data1063 key1064]
    (clojure.core/with-open
     [data1063 (clojure.java.io/input-stream data1063)]
     (clojure.core/let
      [s__874__auto__
       data1063
       c__875__auto__

...
(do
 (do
  (clojure.core/defprotocol
   G__627
   (compute-sha3-512625 [this__228__auto__]))
  (clojure.core/doseq
   [v__229__auto__ [#'G__627 #'compute-sha3-512625]]
 ...
 [(clojure.core/defn
  ...
  (clojure.core/defn
   ...
   [x]
   (pandect.utils.convert/bytes->hex (compute-sha3-512625 x)))])
(do
 (do
  (clojure.core/defprotocol
   G__631
   (compute-sha3-512628 [this__404__auto__ key__405__auto__]))
  (clojure.core/doseq
   [v__406__auto__ [#'G__631 #'compute-sha3-512628]]
   (clojure.core/alter-meta!
    v__406__auto__
    clojure.core/assoc
    :private
   ...
   (compute-sha3-512628
    ...
    (clojure.core/let
     [buf__501__auto__
      data629
      k__502__auto__
      (org.bouncycastle.crypto.params.KeyParameter. key630)
      mac__503__auto__

...
(do
 (do
  (clojure.core/defprotocol
   G__613
   (compute-ripemd256611 [this__228__auto__]))
  (clojure.core/doseq
   [v__229__auto__ [#'G__613 #'compute-ripemd256611]]
 ...
 [(clojure.core/defn
  ...
  (clojure.core/defn
   ...
   [x]
   (pandect.utils.convert/bytes->hex (compute-ripemd256611 x)))])
(do
 (do
  (clojure.core/defprotocol
   G__617
   (compute-ripemd256614 [this__404__auto__ key__405__auto__]))
  (clojure.core/doseq
   [v__406__auto__ [#'G__617 #'compute-ripemd256614]]
   (clojure.core/alter-meta!
    v__406__auto__
    clojure.core/assoc
    :private
